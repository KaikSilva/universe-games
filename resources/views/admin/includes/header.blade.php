            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="{{ route('admin.home') }}">
                        <img src="{{ asset('backend/assets/images/logo/universe_games__5_-removebg-preview.png') }}" alt="Logo">
                        <img class="logo-fold" src="{{ asset('backend/assets/images/logo/universe_games__7_-removebg-preview.png') }}">
                    </a>
                </div>
                <div class="logo logo-white">
                    <a href="{{ route('admin.home') }}">
                        <img src="{{ asset('backend/assets/images/logo/universe_games__5_-removebg-preview.png') }}" alt="Logo">
                        <img class="logo-fold" src="{{ asset('backend/assets/images/logo/universe_games__5_-removebg-preview.png') }}" >
                    </a>
                </div>
                <div class="nav-wrap">
                    <ul class="nav-left">
                                ...
                                <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                                    <div class="d-flex m-r-50">
                                        ...
                                        <div class="m-l-10">
                                            ...
                                            <p class="m-b-0 opacity-07">Colaborador(a)</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="">
                                    <a href="{{ route('admin.all.post') }}">Todos os posts</a>
                                </li>
                                <li>
